...
- [x] 5.1 Evaluation runner reads all 10 F-03 prepared cases. — 18b979d
- [x] 5.2 Evaluation runner reports the four scope classes: `in_scope`, `missing_context`, `mixed_scope`, and `out_of_scope`. — 18b979d
- [x] 5.3 Evaluation runner distinguishes PRD accuracy cases from guardrail-only cases using `counts_toward_prd_accuracy`. — 18b979d
- [x] 5.4 `package.json` defines `diagnosis:evaluate` for `scripts/evaluate-diagnosis-cases.ts`. — 18b979d
- [x] 5.5 Search confirms no smell-check guidance exists in diagnosis prompts, knowledge files, or UI copy. — 18b979d
- [x] 5.6 Search confirms no live web search, saved chat history persistence, image/photo upload, species advice, sharing, export, or fruiting-stage support was added. — 18b979d
- [x] 5.7 Unit tests pass: `npm run test:unit`. — 18b979d
- [x] 5.8 Linting passes: `npm run lint`. — 18b979d
- [x] 5.9 Build passes: `npm run build`. — 18b979d
