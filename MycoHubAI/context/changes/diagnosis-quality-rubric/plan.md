...
- Reference directory exists: `Test-Path docs\reference`
...
- Rubric document exists: `Test-Path docs\reference\diagnosis-quality-rubric.md`
- Rubric contains scoring scale text: `rg "0/1/2|case threshold|critical failure" docs\reference\diagnosis-quality-rubric.md`
- Rubric contains scope handling text: `rg "mixed-scope|out-of-scope|agar|grain|follow-up" docs\reference\diagnosis-quality-rubric.md`
- Lint still passes: `npm run lint`
...
- Contract surfaces registry exists: `Test-Path docs\reference\contract-surfaces.md`
- Contract surfaces registry references the diagnosis artifacts: `rg "diagnosis-quality-rubric|diagnosis-evaluation-cases" docs\reference\contract-surfaces.md`
...
- [ ] 1.1 Change folder exists: `Test-Path context\changes\diagnosis-quality-rubric`
- [ ] 1.2 Change identity exists: `Test-Path context\changes\diagnosis-quality-rubric\change.md`
- [ ] 1.3 Reference directory exists: `Test-Path docs\reference`
- [ ] 1.4 Lint still passes: `npm run lint`

#### Manual

- [ ] 1.5 `change.md` correctly describes F-02 as a rubric/documentation foundation and not as selected-log diagnosis runtime work.
- [ ] 1.6 No files are created under `context/archive/`.

### Phase 2: Diagnosis Quality Rubric

#### Automated

- [ ] 2.1 Rubric document exists: `Test-Path docs\reference\diagnosis-quality-rubric.md`
- [ ] 2.2 Rubric contains scoring scale text: `rg "0/1/2|case threshold|critical failure" docs\reference\diagnosis-quality-rubric.md`
- [ ] 2.3 Rubric contains scope handling text: `rg "mixed-scope|out-of-scope|agar|grain|follow-up" docs\reference\diagnosis-quality-rubric.md`
...
- [ ] 4.1 Contract surfaces registry exists: `Test-Path docs\reference\contract-surfaces.md`
- [ ] 4.2 Contract surfaces registry references the diagnosis artifacts: `rg "diagnosis-quality-rubric|diagnosis-evaluation-cases" docs\reference\contract-surfaces.md`
